    ...
    return (
      <div className="bg-neutral-900/50 rounded-xl border border-neutral-800 p-6">
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-neutral-400 mb-4">Connect your wallet to see your analytics</p>
  ...
  return (
    <div className="bg-neutral-900/50 rounded-xl border border-neutral-800 p-6">
      ...
      <div className={`${pnlBgColor} rounded-xl p-4 mb-6`}>
        <p className="text-sm text-neutral-400 mb-1">Net P&L</p>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div>
          <p className="text-xs text-neutral-500 mb-1">Total Staked</p>
          <p className="text-lg font-medium text-white">{stats.totalStakedFormatted} STX</p>
        </div>
        <div>
          <p className="text-xs text-neutral-500 mb-1">Total Winnings</p>
          <p className="text-lg font-medium text-emerald-400">{stats.totalWinningsFormatted} STX</p>
        </div>
        <div>
          <p className="text-xs text-neutral-500 mb-1">Total Losses</p>
          <p className="text-lg font-medium text-red-400">{stats.totalLossesFormatted} STX</p>
        </div>
        <div>
          <p className="text-xs text-neutral-500 mb-1">Predictions</p>
          <p className="text-lg font-medium text-white">{stats.totalPredictions}</p>
        </div>
      </div>
      ...
      <div className="border-t border-neutral-800 pt-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-sm font-medium text-white">{stats.winRate.toFixed(1)}%</span>
        </div>
      ...
      {stats.pendingPositions > 0 && (
        <div className="mt-4 pt-4 border-t border-neutral-800">
          <div className="flex items-center justify-between">
            <span className="text-sm text-neutral-400">Pending Positions</span>
